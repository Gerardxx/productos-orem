...
export function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex items-center pt-20 px-6 overflow-hidden bg-white">
      {/* Decoración - Luces suaves de fondo */}
      ...
      <div className="max-w-6xl mx-auto w-full grid lg:grid-cols-12 gap-10 items-center relative z-10">
        ...
        >
          <span className="font-sans text-[10px] uppercase tracking-[0.4em] text-stone-400 mb-8 block font-semibold">
            Naturaleza que transforma — Lima 2026
          </span>

          <h1 className="font-serif italic text-[11vw] lg:text-[7.5vw] leading-[0.82] mb-10 text-stone-900 tracking-tighter">
            Limpieza <br /> con{" "}
          ...
          <div className="flex flex-col sm:flex-row gap-8 items-start sm:items-center">
            <Link
              href="/catalogos"
              /* CORRECCIÓN: bg-terracota nativo y efectos de hover refinados */
        ...
        >
          <div className="relative aspect-[4/5] lg:aspect-[3/4] rounded-[2.5rem] overflow-hidden shadow-[0_40px_80px_rgba(0,0,0,0.1)] border-[12px] border-white bg-stone-100">
            <Image
            ...
            {/* Overlay de gradiente para texto sobre imagen */}
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-60" />

            <div className="absolute bottom-8 left-8 text-white">
              <p className="font-sans text-[9px] uppercase tracking-[0.2em] opacity-80 mb-1 font-medium">
                Colección 01
              </p>
          ...
          {/* Elemento decorativo flotante detrás de la imagen */}
